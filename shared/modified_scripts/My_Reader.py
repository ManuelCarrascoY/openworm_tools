...
#The main difference from UpdatedSpreadsheetDataReader is that it reads the sherm_full_edgelist_MODIFIED.csv
...
filename = "%smy_connections.csv" % spreadsheet_location
...
def main():
    ...
    cells, conns = read_data(include_nonconnected_cells=False)
