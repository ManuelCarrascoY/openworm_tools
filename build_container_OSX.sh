...
# Find the DISPLAY ip of your computer
...
docker exec $NAME cp ./shared/modified_scripts/* -t /home/ow/c302/c302/ #Copy modified_scripts into c302/
docker exec $NAME cp ./shared/modified_data/* -t /home/ow/c302/c302/data/ #Copy modified_data into c302/data/
