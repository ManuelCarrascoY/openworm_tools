...
def setup(parameter_set,
    ...
    cells_to_plot = cells
    reference = "c302_%s_BW_VNC_muscles" % parameter_set
    ...
    for stim_num in range(total_stim):
        ...
        for muscle_num in range(7):
            ...
            startd = '%sms' % (600 + 400 + stim_num * 800 + count * 30)
            startv = '%sms' % (600 + stim_num * 800 + count * 30)
    ...
    #*************************
    #'''
    input_list.append(('AVAL', '0ms', '6000ms', '15pA'))
    input_list.append(('AVAR', '0ms', '6000ms', '15pA'))
    #'''
    ...
    #sine_input_list.append(('VB1', '0ms', '15000ms', '1.5pA', '800ms')) # CHANGE THIS TO 6000 ms
    sine_input_list.append(('DA9', '0ms', '6000ms', '-2.5pA', '800ms'))
    sine_input_list.append(('VA12', '0ms', '6000ms', '2.5pA', '800ms'))
    ...
    param_overrides = {
        ...
        'mirrored_elec_conn_params': {
            ...
            r'^AVA._to_DA\d+\_GJ$_elec_syn_gbase': '0.0005 nS',
            r'^AVA._to_VA\d+\_GJ$_elec_syn_gbase': '0.0005 nS',
